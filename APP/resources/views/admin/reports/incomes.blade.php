...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Non-loan income by category</p>
        </div>
        <a href="{{ route('admin.incomes.create') }}" class="btn btn-success btn-sm">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.reports.incomes') }}">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.reports.incomes') }}" class="btn btn-outline-secondary btn-sm">Reset</a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="h4 fw-bold text-success">UGX {{ number_format($grandTotal, 2) }}</div>
        ...
        <div class="col-md-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="h4 fw-bold">{{ $incomes->count() }}</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end fw-semibold text-success">{{ number_format($data['total'], 2) }}</td>
                        <td class="text-end">
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 fw-bold text-primary">Income Detail</h6>
        </div>
        <div class="card-body p-0">
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('admin.incomes.show', $income->id) }}">
                                    <code>{{ $income->receipt_number }}</code>
                                </a>
                            </td>
                            <td>{{ $categories[$income->category]['name'] ?? ucfirst($income->category) }}</td>
                            <td class="text-success fw-semibold">{{ number_format($income->amount, 2) }}</td>
