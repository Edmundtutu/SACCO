    ...
    <>
      ...
      <div className="p-4 md:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          {/* If Non active loans exisit show their stat card */}
          {nonActiveLoans && (
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold font-heading">{nonActiveLoans.length}</p>
                  </div>
                  <div className="h-12 w-12 bg-gray-100 dark:bg-gray-900/20 rounded-lg flex items-center justify-center">
